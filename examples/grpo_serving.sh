export SFT_GPU=6
export PPO_GPU=8
export SFT_PORT=9095
export PPO_PORT=9099
export SFT_MODEL_FOLDER_NAME="sft_qwen25_7b_sft_round_1_bc_data_top_2"
export PPO_MODEL_FOLDER_NAME="grpo_tom_rm_goal_w_relationship_sft_r1"
export SFT_MODEL_CKPT_STEP=1500
export PPO_MODEL_CKPT_STEP=2250
...
export PPO_MODEL_PATH="${REPO_FOLDER_NAME}/checkpoints/${PPO_MODEL_FOLDER_NAME}/checkpoint-${PPO_MODEL_CKPT_STEP}/"
export ENV_MODEL="gpt-4o"


export TAG="${PPO_MODEL_FOLDER_NAME}_step_${PPO_MODEL_CKPT_STEP}_vs_${SFT_MODEL_FOLDER_NAME}_step_${SFT_MODEL_CKPT_STEP}"
